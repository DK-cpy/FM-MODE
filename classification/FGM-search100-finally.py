...
def main():
    ...
    parser.add_argument('--data', type=str, default='fasterdatasets/cifar-100', help='数据路径')
    ...
    # 目录和日志配置
    DIR = f"FGM-multi-objective-diffevo-cifar100-{time.strftime('%Y%m%d-%H%M%S')}"
    if args.dir:
    ...
    for epoch in range(args.epochs):
        ...
        torch.save(filtered_state, os.path.join(DIR, "model-cifar100.pt"))
        scheduler.step()
